const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MACHOKE]               = {{EVO_LEVEL, 50, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]              = {{EVO_LEVEL, 50, SPECIES_GOLEM}},
    ...
    [SPECIES_HAUNTER]               = {{EVO_LEVEL, 50, SPECIES_GENGAR}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_LEVEL, 45, SPECIES_GIGALITH}},
    ...
    [SPECIES_GURDURR]               = {{EVO_LEVEL, 45, SPECIES_CONKELDURR}},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 50, SPECIES_GOLEM_ALOLAN}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_LEVEL, 40, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_LEVEL, 40, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_LEVEL, 40, SPECIES_GOURGEIST_SUPER}},
#endif
#if P_GEN_7_POKEMON == TRUE
